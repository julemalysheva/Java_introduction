...
/*Использование методов компаратора Java 8 по умолчанию
Интерфейс Comparator содержит различные заводские методы по умолчанию для создания Comparator экземпляров.

Все, Comparators что мы создали в предыдущем разделе, можно сделать более кратким, используя эти фабричные методы.

Вот тот же пример компаратора, который мы видели в предыдущем разделе, с использованием методов компаратора
Java 8 по умолчанию:*/
public class ComparatorExampleJava {
