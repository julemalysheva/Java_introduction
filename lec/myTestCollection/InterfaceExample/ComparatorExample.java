...
/*Давайте посмотрим, как отсортировать коллекцию Employee объектов, которые мы определили в предыдущем разделе,
на основе разных полей, определив разные файлы Comparators.*/
public class ComparatorExample {
    ...
    /*Как вы видели в приведенном выше примере, все методы сортировки также принимают экземпляр Comparator интерфейса.
     Они используют порядок, определенный функцией Comparator интерфейса, compare()для сортировки объектов.*/
}